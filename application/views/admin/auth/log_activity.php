                                        ...
                                        <?php 
                                            ...
                                            foreach ($row->result() as $key => $data) { 
                                                if($data->logout_date == null){?>
                                                    <tr>
                                                        <td><?=$no++?></td>
                                                        <td><?=ucfirst($data->username_user_admin)?></td>
                                                        <td>Bidang <?=admin_role($data->role_user_admin)?></td>
                                                        <td><?=$data->os_user?></td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <?php if ($data->logout_date == null) { ?>
                                                                <a href="<?=site_url('admin/user/forced/'.$data->id_user)?>" style="color: black;"><i class="icon-exit"></i></a>
                                                            <?php } ?>
                                                        </td>
                                                    </tr>
                                                <?php }
