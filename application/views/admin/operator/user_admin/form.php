<div class="panel-heading">
	<h4 class="panel-title"><b> Laman <?=ucfirst($this->uri->segment(4))?> User Admin </b></h4>
...
<div class="panel-body">
	...
	<?=form_open('admin/operator/user_admin/proses')?>
		<div class="row">
			<div class="col-lg-12">
				<div class="tabbable">
									...
									<div class="panel panel-flat timeline-content">
										<div class="panel-body">
											...
											<div class="form-group">
												<div class="row">
                                                    <div class="col-lg-4">
                                                        <label>Pengelola Bidang *</label>
                                                        <select name="p_role" class="form-control">
                                                            <option value="">- pilih -</option>
                                                            <option value="1" <?=$row->role_user_admin == 1 ? 'selected' : null ?>> Bidang Operator </option>
                                                            <option value="2" <?=$row->role_user_admin == 2 ? 'selected' : null ?>> Bidang Tata Usaha </option>
                                                            <option value="3" <?=$row->role_user_admin == 3 ? 'selected' : null ?>> Bidang Akademik </option>
                                                            <option value="4" <?=$row->role_user_admin == 4 ? 'selected' : null ?>> Bidang Kesiswaan </option>
                                                            <option value="5" <?=$row->role_user_admin == 5 ? 'selected' : null ?>> Bidang Keuangan</option>
                                                        </select>
                                                    </div>
													<div class="col-sm-4">
														<label>E-Mail *</label>
            ...
            <div class="col-lg-12">
					<button type="submit" name="<?=$this->uri->segment(4)?>" class="btn bg-teal-400" style="width: 100%;">Perbaharui Profil <i class="icon-circle-right2"></i></button>								
				</div>
		</div>
	<?=form_close()?>	
</div>