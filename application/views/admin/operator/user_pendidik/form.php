<div class="panel-heading">
	<h4 class="panel-title"><b> Laman <?=ucfirst($this->uri->segment(4))?> User Tenaga Pendidik </b></h4>
...
<div class="panel-body">
	...
	<form action="<?=site_url('admin/operator/user_pendidik/proses')?>" method="post">
		<div class="row">
			<div class="col-lg-12">
				<div class="tabbable">
									...
									<div class="panel panel-flat timeline-content">
										<div class="panel-body">
											<div class="form-group">
												...
												<div class="row">
													<div class="col-sm-6 <?=$this->session->flashdata('c_nip') != null ? 'has-error' : null?>">
														<label>NIP Tenaga Pendidik *</label>
														<input type="number" name="up_nip" placeholder="ex. 164819374" class="form-control" value="<?=$this->session->flashdata('nip')?>" required>
                                                        <span class="help-block"><?=$this->session->flashdata('c_nip')?></span>
                                                    </div>
                                                    <div class="col-sm-6">
														<label>E-Mail Tenaga Pendidik *</label>
                                                ...
                                                <?php }else if($this->uri->segment(4) == 'update'){ ?>
                                                    <fieldset class="content-group">
                                                        <div class="form-group has-feedback ">
                                                            <label class="control-label col-lg-2 text-semibold mt-20">NIP Tenaga Pendidik</label>
                                                            <div class="col-lg-10 mt-15">
                                                                <input type="hidden" name="id" value="<?=$row->id_user?>">
                                                                <input type="number" class="form-control" value="<?=$row->nip_pendidik?>" readonly>
                                                            </div>
                                                        </div>
